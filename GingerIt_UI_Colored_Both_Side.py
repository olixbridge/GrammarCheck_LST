...
def main():
    ...
    text3.tag_config('a', background='#d2ffd2', foreground = 'darkgreen')
    text.tag_config('b',background = '#FFD2D2', foreground='red')
        ...
        if result['Suggestions']:
            ...
            if len(nonColoredText) > 0 :
                ...
                if from_index != 0 and nonColoredText[-1] != "\n" :
                    ...
                    text.insert(tk.END, nonColoredText)
                else :
                    text3.insert(tk.END, nonColoredText)
                    text.insert(tk.END, nonColoredText)
			# add colored suggest :
            text3.insert(tk.END, colored_suggest, 'a')
            text.insert(tk.END, colored_incorrect,'b')
    ...
    text.insert(tk.END, fixed_text[lastSuggestIndex:])
